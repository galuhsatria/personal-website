...
export default function Navbar() {
  ...
  return (
    <header
      className={`w-full mx-auto border-b border-border px-4 py-2 fixed top-0 z-50 transition-transform duration-30 bg-background ${visible ? "max-sm:-translate-y-24" : ""}`}
    >
