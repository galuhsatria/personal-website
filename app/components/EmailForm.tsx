  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <Button type="submit" className='w-full'>{loading ? <RiLoader4Fill className="animate-spin"/> : <span className='flex items-center gap-2'>Send Message <Send size={16}/></span>}</Button>
      </form>
    </div>
  );
}
