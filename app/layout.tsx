...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Explore the personal projects, portfolio, and writings of Galuh Satria.",
  ...
  twitter: {
    ...
    description:
      "Explore the personal projects, portfolio, and writings of Galuh Satria.",
    images: [
      `${process.env.NEXT_PUBLIC_WEB_DOMAIN}/api/og?title=Galuh%20Satria%20Portfolio%20%26%20Blog&description=Explore%20the%20personal%20projects%2C%20portfolio%2C%20and%20writings%20of%20Galuh%20Satria`,
    ],
  },
};
    ...
    <html lang="en">
      <head>
        <script
          ...
          data-website-id="c5deca0e-365b-45e5-99ae-a6a10a10cb4a"
        ></script>
      </head>
